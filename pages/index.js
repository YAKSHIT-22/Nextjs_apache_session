      ...
      <section className="text-gray-600 body-font">
        <div className="container px-5 py-10">
          <div className="flex flex-col text-center w-full">
            <h2 className="text-xs text-blue-500 tracking-widest font-medium title-font mb-1">Let&apos;s make winter adventures!</h2>
          ...
          <Link href="/products">
            <button className="flex mx-auto mt-5 text-white bg-blue-500 border-0 py-2 px-8 focus:outline-none hover:bg-blue-600 rounded text-lg">Shop Now</button>
          </Link>
        </div>
      </section>
    </div>
