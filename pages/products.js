                            ...
                            return (
                                <div key={item.slug} className="xl:w-1/4 md:w-1/2 p-4" >
                                    <div className="bg-gray-100 p-6 rounded-lg">
                                        ...
                                        <h3 className="tracking-widest text-blue-500 text-xs font-medium title-font">{item.category}</h3>
                                        <h2 className="text-lg text-gray-900 font-medium title-font mb-4">{item.name} </h2>
                                        <span className='hidden bg-red-800' />
                                        <p className="leading-relaxed text-base">{item.description}</p>
                                        <Link href={`/product/${item.slug}`}>
                                            <button className="my-2 text-white bg-blue-500 border-0 py-1 px-2 focus:outline-none hover:bg-blue-600 rounded text-sm">Buy Now</button>
                                        </Link>
                                    </div>
                                </div>
                            )
